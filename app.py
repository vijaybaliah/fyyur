...
def venues():
    ...
    # shows per venue.
    # state_city_query = db.session.query(Venue.state,
    #                                     Venue.city).\
    #     group_by(Venue.id, Venue.state,
    #              Venue.city).subquery()

    # venues_list = Venue.query.join(state_city_query,
    #                                Venue.city == state_city_query.c.city).\
...
def show_venue(venue_id):
    ...
    # venue["genres"] = venue.genres.replace("{", "", 1)
    # venue["genres"] = venue.genres.replace("}", "", -1)
    # venue.genres = venue.genres.split(',')
    setattr(venue, 'past_shows', [])
    setattr(venue, 'past_shows_count', 0)
    setattr(venue, 'upcoming_show', [])
    setattr(venue, 'upcoming_shows_count', 0)
    # data1 = {
    #     "id": 1,
